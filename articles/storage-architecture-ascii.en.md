# Bitcoin Core Storage Architecture: Complete ASCII Reference

[中文](storage-architecture-ascii.zh.md)

---

> This article presents the complete Bitcoin Core storage architecture as ASCII diagrams, covering in-memory structures, LevelDB databases, flat files, optional indexes, and flush ordering. All key/value schemas are derived from source code.
> Related articles: [Disk Storage Layout](disk-storage-layout.en.md), [Flush Timing and Ordering](index-flush-ordering.en.md), [PR #34897 Analysis](index-flush-pr34897.en.md)
...
## Data Dependency and Pointer Map
...
## Flush Ordering (FlushStateToDisk)
